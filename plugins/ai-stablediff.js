...
let wife = await fetch(`https://api.itsrose.life/image/diffusion/txt2img?server_name=frieren&prompt=${logo4}&negative_prompt=${logo6}&width=576&height=1024&steps=30&model_id=${logo9}&sampler=UniPC&cfg=7.5&enhance_prompt=no&multi_lingual=yes&image_num=1&safety_checker=no&panorama=no&lora_model=${lora_model}&lora_strength=1&hiresFix=no&tomesd=yes&use_karras_sigmas=yes&clip_skip=2&apikey=Rs-edgarsan`)
